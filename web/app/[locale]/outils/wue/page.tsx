    ...
    <div className="min-h-screen bg-[#F8FAFC] text-[#032D60]">
      <header className="bg-[#032D60] text-white">
        <div className="max-w-[720px] mx-auto px-6 py-10">
          ...
          <h1 className="mt-3 text-[32px] md:text-[40px] font-extrabold">Efficacité eau</h1>
          <p className="mt-3 text-blue-100">Litres consommés par la salle ÷ kWh des machines. Compteur d’eau + même mois que l’électricité.</p>
        </div>
      </header>
