  ...
  return (
    <Providers>
      ...
      <div className="max-w-[1440px] mx-auto px-6 py-6">
        ...
        <p className="text-[13px] text-[#444] max-w-[800px] mt-1">Traçabilité complète grid, groupe, UPS, PDU, rack, device, cellule batterie.</p>
        <div className="mt-3"><MetricsLinks locale={locale} current="/power" /></div>
        <div className="mt-4 max-w-[420px]"><LivePue rackId="RACK-05" /></div>
        <div className="mt-6">
          <PowerFlow/>
        </div>
